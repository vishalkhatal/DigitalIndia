<%@ Page Title="User - Listing All Form(s)" Language="C#" MasterPageFile="~/Main2.master" AutoEventWireup="true" CodeFile="ListAllForms.aspx.cs" Inherits="ListAllForms" %>
...
<td>
<div>
    <asp:Label ID="errmsg" runat="server" Text="Message" ForeColor="Red"></asp:Label>
</div>
</td>
</tr>
...
<table align="left" width="100%">
    ...
    <td colspan="2" width="100%" align="left" bgcolor="#ffffff"> 
        ...
        <ItemTemplate>
            <a href='ImgView.aspx?appid=<%# Eval("appid") %>'><asp:Label ID="appid" runat="server" Text='<%# Eval("appid") %>'></asp:Label></a>
        </ItemTemplate>
        </asp:TemplateField>
