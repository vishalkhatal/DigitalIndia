...
public partial class ListAllForms2 : System.Web.UI.Page
{
    string un = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            qry = "select * from userappinfo where appstatus='Waiting'";
            getAllUserForms(qry);
        }
    }
    ...
    {
        qry = "select * from userappinfo where apptype='" + ddlType.Text + "'";
        getAllUserForms(qry);
    }
    
    protected void Button2_Click(object sender, EventArgs e)
    {
        qry = "select * from userappinfo";
        getAllUserForms(qry);
    }
}