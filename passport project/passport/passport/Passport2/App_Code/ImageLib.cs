...
public class CardTemp
{
    ...
    public static void createID(string name, string dob, string photo, string imgname)
    {
        int width = 242;
        int height = 369;
        ...
        g.DrawString("Blood Group: ", ff2, Brushes.Blue, 20, 290);
        g.DrawString("A +ve", ff2, Brushes.Black, 120, 290);

        g.DrawString("Date of Birth: ", ff2, Brushes.Blue, 20, 320);
        g.DrawString(dob, ff2, Brushes.Black, 120, 320);
