<%@ Page Title="Admin - Card List" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true" CodeFile="CardList.aspx.cs" Inherits="CardList" %>
...
Select Type : &nbsp;&nbsp;
    ...
    <br /><br />
    <asp:Label ID="errmsg" runat="server" Text="" Font-Size="Large" ForeColor="Red"></asp:Label>
</div>
</td>
</tr>
...
<table align="left" width="100%">
    ...
    <td colspan="2" width="100%" align="left" bgcolor="#ffffff"> 
        ...
        <asp:GridView ID="GridView1" runat="server" Height="100%" Width="100%" 
            ...
            ForeColor="#333333" GridLines="None" EmptyDataText="There is no any generated card">
        ...
        <ItemTemplate>
            <a href='ViewCard.aspx?appid=<%# Eval("appid") %>'>View Card</a>
        </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Card Date">        
        <ItemTemplate>
        <%# Eval("ccdt") %>
        </ItemTemplate>
        </asp:TemplateField>               
