<%@ Page Title="User - Change Password" Language="C#" MasterPageFile="~/Site3.master" AutoEventWireup="true" CodeFile="CPwd.aspx.cs" Inherits="CPwd" %>
...
<table align="center" width="100%">    
    ...
    <td align="left" width="40%" bgcolor="#ffffff" style="color:Blue;height:20px">
        ...
        <asp:Label ID="Label1" runat="server" Text="Confirm Password" Font-Size="Small" 
